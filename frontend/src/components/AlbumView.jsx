        ...
        data.forEach(album => {
          if (
            ...
            ((this.state.sortType === "rotation" &&
              (album.Rotation_flag === 1 ||
                album.Rotation_flag === "✅")) ||
              (this.state.sortType === "notRotation" &&
                (album.Rotation_flag === 0 ||
                  album.Rotation_flag === " ")))
          ) {
        ...
        return (
          <div className="album-list">
            ...
            <div className="filter-selector">
              Filter:{" "}
              <button onClick={this.changeSortType} name="default">Default</button>
              <button onClick={this.changeSortType} name="rotation">In rotation</button>
              <button onClick={this.changeSortType} name="notRotation">Out of rotation</button>
            </div>
